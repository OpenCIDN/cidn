...
metadata:
  ...
  annotations:
    webui.task.opencidn.daocloud.io/display-name: "Blob with hash error {{.Destination}}"
spec:
...
metadata:
  ...
  annotations:
    webui.task.opencidn.daocloud.io/display-name: "Blob with one source and one destination {{.Destination}}"
    webui.task.opencidn.daocloud.io/group: "blob.1-1"
spec:
...
metadata:
  ...
  annotations:
    webui.task.opencidn.daocloud.io/display-name: "Blob with two sources and two destinations {{.Destination}}"
spec:
