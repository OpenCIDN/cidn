...
func schema_pkg_apis_task_v1alpha1_Blob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Description: "Spec holds information about the request being evaluated.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/OpenCIDN/cidn/pkg/apis/task/v1alpha1.BlobSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/OpenCIDN/cidn/pkg/apis/task/v1alpha1.BlobStatus"),
						},
					},
				},
				Required: []string{"spec"},
		...
		Dependencies: []string{
			"github.com/OpenCIDN/cidn/pkg/apis/task/v1alpha1.BlobSpec", "github.com/OpenCIDN/cidn/pkg/apis/task/v1alpha1.BlobStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_task_v1alpha1_BlobList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/OpenCIDN/cidn/pkg/apis/task/v1alpha1.Blob"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/OpenCIDN/cidn/pkg/apis/task/v1alpha1.Blob", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"sha256PartialPreviousName": {
						SchemaProps: spec.SchemaProps{
							Description: "Sha256PartialPreviousName indicates if this is an initial block when set to \"-\"",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"sha256": {
						SchemaProps: spec.SchemaProps{
							Description: "Sha256 is the expected SHA256 hash of the complete content",
							Type:        []string{"string"},
							Format:      "",
						},
					},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"sha256Partial": {
						SchemaProps: spec.SchemaProps{
							Description: "Sha256Partial contains sha256 hash that is partially calculated and saved",
							Type:        []string{"string"},
							Format:      "byte",
						},
					},
					"sha256": {
						SchemaProps: spec.SchemaProps{
							Description: "Sha256 is the sha256 hash of the resource snapshot being verified.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"etags": {
						SchemaProps: spec.SchemaProps{
							Description: "Etag is the ETag of the resource snapshot being verified.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
